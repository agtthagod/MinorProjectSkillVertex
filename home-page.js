...
$(document).ready(function(event) {
    ...
    var product = {
        ...
        "Movies_array": [{
            ...
            "id": "movie_3",
            "name": "What They Had",
            "photo": "https://m.media-amazon.com/images/M/MV5BMTc4NzIyODE3Nl5BMl5BanBnXkFtZTgwNjg2NTc5NTM@._V1_.jpg",
            "category": "Movies",
    ...
    function addToPage(a) {
        for (var j = 0; j < a.length; j++) {
            $('.grid-container').append('<section ><img/><div class="overlay"><ul><li class="name"></li><li class="category"></li><li class="price"><span></span> rupees</li><li class="info"></li></ul> <a href="#productPage" class="details">More Details</a><button type="button" class="buy">Add To Cart</button></div></section>');
    ...
    $('body').on('click', '.buy', function(e) {
        ...
        $('#' + liId + ' .price').text($('#' + parentSection + " .price span").text() + " rupees");
        var itemPrice = +$('#' + parentSection + " .price span").text();
        total += itemPrice;
        $('.scroll span').text(total + " rupees");
        $('.scroll .empty').hide();
        $('.scroll .total').show();
    });
    ...
    $('body').on('click', '.details', function(e) {
        ...
        $('#productId' + parentSection).append('<img/><ul><li class="name"></li><li class="category"></li><li class="summary"></li><li class="price"><span></span> rupees</li></ul><button type="button" class="buy">Add To Cart</button>');
